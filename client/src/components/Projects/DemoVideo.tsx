...
const DemoVideo = () => {
  ...
  return (
    <>
      <div
        className={`  fixed left-0 top-0 h-screen w-full bg-[#000000] flex flex-col justify-center items-center z-40 select-none`}
      >
        ...
        <div className="w-full h-[93%] flex justify-center items-center">
          <video className=" w-[80%] h-[80%]" controls>
            <source src="/assets/images/images/video.mp4" type="video/mp4" />
          </video>
        </div>
      </div>
    </>
