...
import { Navbar, NavbarBrand, NavbarContent, NavbarItem, NavbarMenuToggle, NavbarMenu, NavbarMenuItem, Button, Switch, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem } from "@nextui-org/react";
import { VikashKumar } from "./VikashKumar.tsx";
    ...
    return (
        <Navbar onMenuOpenChange={setIsMenuOpen}>
            ...
            <NavbarContent justify="center" className="lg:hidden">
                <NavbarBrand >
                    <NavLink to="/" className=" text-[#000000] flex justify-center items-center dark:text-[#FFFFFF]">
                        <VikashKumar />
            ...
            <NavbarContent className="hidden lg:flex gap-4" justify="center">
                <NavbarItem>
                    <NavLink color="foreground" className=" text-sm font-bold" to="/about">
                        About
                    </NavLink>
                </NavbarItem>
                <NavbarItem>
                    <NavLink className=" text-sm  font-bold" color="foreground" to="/contact">
                        Contact
                    </NavLink>
                </NavbarItem>
                <NavbarItem>
                    <Dropdown>
                        ...
                        <DropdownMenu aria-label="Static Actions" className=" text-[#000000] dark:text-[#FFFFFF]">
                ...
                <NavbarItem>
                    <NavLink className=" text-sm font-bold " color="foreground" to="/projects">
                        Projects
                    </NavLink>
                </NavbarItem>
                <NavbarItem>
                    <NavLink className=" text-sm  font-bold" color="foreground" to="/experience">
                        Experience
                    </NavLink>
                </NavbarItem>
                <NavbarItem>
                    <NavLink className=" text-sm  font-bold" color="foreground" to="/education">
                        Education
                    </NavLink>
                </NavbarItem>
            </NavbarContent>
            ...
            <NavbarMenu>
                {menuItems.map((item, index) => (
                    <NavbarMenuItem key={`${item}-${index}`} className=" text-[#000000] dark:text-[#FFFFFF]">
                        <NavLink
                            color={
                ...
                <NavbarItem  >
                    <Button as={NavLink} className="w-[150px] mt-5" color="primary" href="#" variant="flat">
                        Login
                    </Button>
                </NavbarItem>
            </NavbarMenu>
